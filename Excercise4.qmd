...
DTW(traj2, traj3, pointSpacing=-1)
DTW(traj3, traj4, pointSpacing=-1)
DTW(traj4, traj5, pointSpacing=-1)
DTW(traj5, traj6, pointSpacing=-1)
...
EditDist(traj2, traj3, pointDistance=20)
EditDist(traj3, traj4, pointDistance=20)
EditDist(traj4, traj5, pointDistance=20)
EditDist(traj5, traj6, pointDistance=20)
EditDist(traj6, traj2, pointDistance=20)
